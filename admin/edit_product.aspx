<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="edit_product.aspx.cs" Inherits="admin_edit_product" %>
        ...
        <div class="card" style="padding: 10px">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-10">
                 ...
                 <div class="form-group col-md-10">
                                     <asp:Image ID="i1" runat="server" Height="100" Width="100" />
                </div>


                <div class="form-group col-md-10">
                    <label for="productname" class="col-form-label">Change Image</label>
                ...
                <div class="form-group col-md-10">
                    <asp:Button ID="b1" runat="server" Text="Update Product" class="btn btn-primary default-btn-color" OnClick="b1_Click"/>
                </div>
